        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-[1.08] tracking-tight">
              Find Your <span className="text-green-600">Flow.</span>
              <br />
              Heal Your Mind.
              <br />
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed mt-6 max-w-xl">
              FlowState is your all-in-one wellness platform for Yoga,
              Meditation and personalized routines. Build healthier habits
              and find your balance every day.
            </p>
            ...
            {!isLoggedIn && (
              <div className="flex flex-col sm:flex-row gap-3 mt-8">
                <Link
                  to="/signup"
                  className="inline-flex items-center justify-center bg-green-600 text-white px-7 py-3.5 rounded-xl font-semibold hover:bg-green-700 transition duration-300 shadow-sm"
                >
                  Start Your Journey →
                </Link>
              </div>
